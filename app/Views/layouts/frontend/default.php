            ...
            <div class="navbar-left">
                <div class="logo-area">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <img class="light" src="<?= base_url('assets/img/logo-white.png') ?>" alt="logo">
                    </a>
                    <a href="#" class="sidebar-toggle">
                        <img class="svg" src="<?= base_url('assets/img/svg/align-center-alt.svg') ?>" alt="img"></a>
                </div>
                <div class="top-menu">
                                ...
                                <ul class="subMenu">
                                    <li>
                                        <a href="editors.html" class="">
                                            <img src="<?= base_url('assets') ?>/img/svg/edit.svg" alt="svg" class="svg nav-icon">
                                            <span class="menu-text">Editors</span>
                                        </a>
                                    </li>
                                    <li class="has-subMenu-left">
                                        <a href="#" class="">
                                            <img src="<?= base_url('assets') ?>img/svg/grid.svg" alt="grid" class="svg nav-icon">
                                    ...
                                    <li class="has-subMenu-left">
                                        <a href="#" class="">
                                            <img src="<?= base_url('assets') ?>img/svg/bar-chart-2.svg" alt="bar-chart-2" class="svg nav-icon">
                                    ...
                                    <li class="has-subMenu-left">
                                        <a href="#" class="">
                                            <img src="<?= base_url('assets') ?>img/svg/disc.svg" alt="disc" class="svg nav-icon">
                                    ...
                                    <li class="has-subMenu-left">
                                        <a href="#" class="">
                                            <img src="<?= base_url('assets') ?>img/svg/map.svg" alt="map" class="svg nav-icon">
                                    ...
                                    <li class="has-subMenu-left">
                                        <a href="#" class="">
                                            <img src="<?= base_url('assets') ?>img/svg/square.svg" alt="square" class="svg nav-icon">
                                    ...
                                    <li class="has-subMenu-left">
                                        <a href="#" class="">
                                            <img src="<?= base_url('assets') ?>img/svg/book.svg" alt="book" class="svg nav-icon">
                ...
                <ul class="navbar-right__menu">
                    <li class="nav-author">
                        <div class="dropdown-custom">
                            <a href="javascript:;" class="nav-item-toggle"><img src="<?= base_url('assets') ?>/img/author-nav.jpg" alt="" class="rounded-circle">
                                ...
                                <div class="dropdown-wrapper">
                                    <div class="nav-author__info">
                                        <div class="author-img">
                                            <img src="<?= base_url('assets') ?>/img/author-nav.jpg" alt="" class="rounded-circle">
                                        </div>
                                        <div>
